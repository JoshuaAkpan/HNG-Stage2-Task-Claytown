  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <section className="py-20 bg-sub-image px-10 text-center h-fit ext-sm sm:text-[16px] lg:text-[20px]">
        <h1 className="text-center font-semibold text-3xl mb-5 text-white">
          Subscribe to our newsletter
        </h1>
        <p className="text-white">Be the first to know about our latest arrivals, exclusive offers</p>
        <p className="text-white">Join us now and get 10% discount off your first purchase</p>
